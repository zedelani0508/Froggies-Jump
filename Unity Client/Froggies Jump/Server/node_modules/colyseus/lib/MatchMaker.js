 ...
 */
function joinOrCreate(roomName, clientOptions = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Utils_1.retry(() => __awaiter(this, void 0, void 0, function* () {
            let room = yield findOneRoomAvailable(roomName, clientOptions);
            if (!room) {
                room = yield createRoom(roomName, clientOptions);
            }
            return yield reserveSeatFor(room, clientOptions);
 ...
 */
function create(roomName, clientOptions = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const room = yield createRoom(roomName, clientOptions);
 ...
 */
function join(roomName, clientOptions = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Utils_1.retry(() => __awaiter(this, void 0, void 0, function* () {
            const room = yield findOneRoomAvailable(roomName, clientOptions);
            if (!room) {
 ...
 */
function joinById(roomId, clientOptions = {}) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function findOneRoomAvailable(roomName, clientOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield awaitRoomAvailable(roomName, () => __awaiter(this, void 0, void 0, function* () {
            ...
            const roomQuery = exports.driver.findOne(Object.assign({ locked: false, name: roomName, private: false }, handler.getFilterOptions(clientOptions)));
